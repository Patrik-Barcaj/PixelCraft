...
export default function Home() { // Home component
  ...
  const heroY = useTransform(scrollY, [0, 500], [0, 150]); // Parallax hero content
  const heroOpacity = useTransform(scrollY, [0, 300], [1, 0]); // Fade hero content

  return ( // Return JSX
    <main className="w-full flex flex-col items-center justify-center flex-1 text-center relative overflow-hidden"> {/* Main hero container */}
      <motion.div /* Animated wrapper */
        style={{ y: heroY, opacity: heroOpacity }} /* Apply parallax */
      ...
      > {/* Close motion div opening */}
        ...
        <motion.div /* Slogan wrapper */
          ...
          className="z-20 mt-0" /* Style wrapper */
        > {/* Close motion div */}
      ...
      <motion.div /* CTA button group wrapper */
        ...
        style={{ y: heroY, opacity: heroOpacity }} /* Parallax */
