...
export default function About() { // Component definition
  return ( // Return JSX
    <section className="w-full max-w-7xl mx-auto px-6 pt-10"> {/* About container */}

      <motion.div /* Animated header */
        initial={{ opacity: 0, y: -20 }} /* Initial state */
        animate={{ opacity: 1, y: 0 }} /* Animate into view */
        className="text-center mb-24" /* Header styling */
      > {/* Close motion div */}
        <h1 className="text-4xl md:text-6xl font-bold uppercase tracking-widest mb-6 drop-shadow-lg">About Pixel Craft</h1> {/* Section title */}
        <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto font-medium">We are a dedicated collective of developers and artists, forging digital environments that breathe, react, and leave a lasting impression.</p> {/* Section subtitle */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8"> {/* Values grid */}
        <MobileCarousel items={[ // Pass cards to carousel
          <motion.div /* Value 1 card */
            ...
            className="glass-panel p-10 rounded-2xl group hover:border-brand-yellow/60 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden shadow-xl bg-black/60 w-full h-full" /* Card styling */
          > {/* Close motion div */}
            ...
            <p className="text-gray-400 leading-relaxed">We push the boundaries of modern technology to craft immersive and highly reactive experiences that captivate players.</p> {/* Description */}
          ...
          > {/* Close motion div */}
            ...
            <p className="text-gray-400 leading-relaxed">Every line of code and every pixel is placed with intent, ensuring optimized performance without sacrificing aesthetic quality.</p> {/* Description */}
          </motion.div>, // Close card
          ...
          > {/* Close motion div */}
            ...
            <p className="text-gray-400 leading-relaxed">We work closely with creators to bring their visions to life, blending their unique ideas with our technical expertise.</p> {/* Description */}
          </motion.div>
